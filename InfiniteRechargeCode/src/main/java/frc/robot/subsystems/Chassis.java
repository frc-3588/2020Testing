...
public class Chassis extends Subsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        leftFrontDrive = new CANSparkMax(0, MotorType.kBrushless);
        leftBackDrive = new CANSparkMax(1, MotorType.kBrushless);
        rightFrontDrive = new CANSparkMax(2, MotorType.kBrushless);
        rightBackDrive = new CANSparkMax(3, MotorType.kBrushless);
    }
